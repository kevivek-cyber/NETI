...
| **4** | **Frontend Engineer — Sakshi** (`Sakshi-Pathare`) | Past-paper ingestion, item tagging, IRT calibration, templatisation, LLM variant pipeline and its validators. | [AI_PIPELINE.md](AI_PIPELINE.md) |
